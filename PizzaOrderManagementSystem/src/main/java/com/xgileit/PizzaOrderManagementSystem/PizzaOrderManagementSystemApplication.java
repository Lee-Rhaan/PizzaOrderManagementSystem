...
public class PizzaOrderManagementSystemApplication {
						  ...
						  DeliveryPersonRepository deliveryPersonRepository)
	{
		return args -> {
			//ID = 1
			managerRepository.save(new Manager("Adam", "Adam@admin.com", "qwerty", "876718676", "76 Strand Street CT")).setActiveStatus(ActiveStatus.LOGGED_OUT);

			//ID = 2
			chefRepository.save(new Chef("James", "James@chef.com", "food", "876331116", "742 Adderley Street CT")).setActiveStatus(ActiveStatus.LOGGED_OUT);
